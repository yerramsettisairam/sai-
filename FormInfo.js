...
class FormInfo extends Component {
    ...
    render() {
        return (
            <div>
                <h2 style={{color:'red'}}>Uncontrolled Input</h2>
                <form onSubmit={this.handleSubmit} >
                    <label>Name: </label>
                    <input type="text" placeholder="Enter Name" ref={this.name} />
                    <p style={{ color: 'green' }}>{this.state.nameError}</p>
                    <label>Age: </label>
                    ...
                    <p style={{ color: 'lightorange' }}> {this.state.designationError} </p>
                    <label> contactNum: </label>
                    <input type="number" placeholder="Enter number" ref={this.contactNum} />
                    <p style={{ color: 'green' }}> {this.state.contactNumError} </p>
